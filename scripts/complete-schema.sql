...
-- ============================================================
-- SEED: 13 Menu Items (with Unsplash images)
-- ============================================================

-- Kopi (2)
INSERT INTO menu_items (category_id, name, description, price, image_url) VALUES
  ((SELECT id FROM categories WHERE name = 'Kopi'), 'Kopi Hitam', 'Kopi hitam robusta kental tanpa gula', 7000, 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Kopi'), 'Es Kopi Susu', 'Es kopi susu segar dengan gula aren', 15000, 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400&h=400&fit=crop');

-- Minuman Dingin (2)
INSERT INTO menu_items (category_id, name, description, price, image_url) VALUES
  ((SELECT id FROM categories WHERE name = 'Minuman Dingin'), 'Es Jeruk', 'Jeruk peras segar dingin premium', 8000, 'https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Minuman Dingin'), 'Es Teh Manis', 'Teh manis segar dengan es batu', 5000, 'https://images.unsplash.com/photo-1544145945-f90425340c7e?w=400&h=400&fit=crop');

-- Makanan Berat (4)
INSERT INTO menu_items (category_id, name, description, price, image_url) VALUES
  ((SELECT id FROM categories WHERE name = 'Makanan Berat'), 'Nasi Lemak', 'Nasi lemak khas dengan sambal, telur, ikan bilis', 20000, 'https://images.unsplash.com/photo-1644556888737-83f4b0a6b7f3?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Makanan Berat'), 'Indomie Goreng Original', 'Indomie goreng klasik dengan telur ceplok', 12000, 'https://images.unsplash.com/photo-1563379926898-05f4575a45d8?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Makanan Berat'), 'Indomie Goreng Spesial', 'Indomie goreng spesial double topping', 18000, 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Makanan Berat'), 'Indomie Kuah', 'Indomie kuah hangat dengan telur rebus', 12000, 'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?w=400&h=400&fit=crop');

-- Camilan (5)
INSERT INTO menu_items (category_id, name, description, price, image_url) VALUES
  ((SELECT id FROM categories WHERE name = 'Camilan'), 'Pisang Goreng', 'Pisang goreng crispy dengan madu', 10000, 'https://images.unsplash.com/photo-1529059997568-3d847b1154f0?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Camilan'), 'Ropang Coklat', 'Roti bakar coklat meleleh', 10000, 'https://images.unsplash.com/photo-1603496987351-f84a3ba45ec4?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Camilan'), 'Ropang Coklat Keju', 'Roti bakar coklat keju premium', 13000, 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Camilan'), 'Ropang Keju', 'Roti bakar keju mozzarella', 12000, 'https://images.unsplash.com/photo-1528736235302-53922df5c531?w=400&h=400&fit=crop'),
  ((SELECT id FROM categories WHERE name = 'Camilan'), 'Kentang Goreng', 'Kentang goreng crispy dengan saus', 12000, 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=400&h=400&fit=crop');
...
CREATE POLICY "Anyone can view menu categories" ON categories FOR SELECT USING (true);
...
UNION ALL SELECT 'koki@warkop.com / freecoffee123'
